...
<!-- chyyuu https://cloud.tencent.com/developer/article/1065771 virtio 简介 -->![两种在虚拟机中模拟外设的总体框架](./two-hypervisor-io-arch.png)
...
![兼容不同虚拟机的外设模拟方案](./compatable-hypervisors-io-arch.png)
...
![image](./virtio-driver-device.png)
