...
本章主要是设计和实现建立支持 **多道程序** 的二叠纪“锯齿螈” <sup>[1](#prionosuchus)</sup> 初级操作系统、支持 **多道程序** 的三叠纪“始初龙” <sup>[2](#eoraptor)</sup> 协作式操作系统和支持 **分时多任务** 的三叠纪“腔骨龙” <sup>[3](#coelophysis)</sup> 抢占式操作系统，从而对可支持运行一批应用程序的多种执行环境有一个全面和深入的理解，并可归纳抽象出 **任务** 、 **任务切换** 等操作系统的概念。
...
<a id="term-multiprogramming"></a>

<a id="term-time-sharing-multitasking"></a>
...
![锯齿螈多道程序操作系统 -- Multiprog OS总体结构](./jcy-multiprog-os-detail.png)
...
![始初龙协作式多道程序操作系统 -- CoopOS总体结构](./more-task-multiprog-os-detail.png)
...
![腔骨龙分时多任务操作系统 -- TimesharingOS总体结构](./time-task-multiprog-os-detail.png)
...
* <a id='eoraptor'>**[2]**</a> 始初龙（也称始盗龙）是后三叠纪时期的两足食肉动物，也是目前所知最早的恐龙，它们只有一米长，却代表着恐龙的黎明。
* <a id='coelophysis'>**[3]**</a> 腔骨龙（也称虚形龙）最早出现于三叠纪晚期，它体形纤细，善于奔跑，以小型动物为食。
