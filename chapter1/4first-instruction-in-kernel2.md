...
提示：在进入本节之前请参考 [实验环境配置](../chapter0/5setup-devel-env.md) 安装配置 Rust 相关软件包、Qemu软件和 GDB 调试工具等。
...
<a id="content-binary-from-elf"></a>
