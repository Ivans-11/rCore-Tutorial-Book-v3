...
- 实现分支：final。
- 运行 [final测例](https://github.com/DeathWish5/rCore_tutorial_tests) ，观察并分析部分测试用例对 OS 造成的不良影响。
...
- 有些测例属于非法程序，比如申请过量内存，对于这些程序，杀死进程其实就是正确的做法。参考: [OOM killer](https://docs.memset.com/other/linux-s-oom-process-killer) 。
...
<a id="term-chapter8-extended-exercise"></a>
...
1. 实现多核支持，设计多核相关测试用例，并通过已有和新的测试用例(难度：8)
   * 某学长的有bug的rcore tutorial参考实现 [https://github.com/xy-plus/rCore-Tutorial-v3/tree/ch7](https://github.com/xy-plus/rCore-Tutorial-v3/tree/ch7?fileGuid=gXqmevn42YSgQpqo)
...
11. 支持 [testsuits for kernel](https://gitee.com/oscomp/testsuits-for-oskernel#testsuits-for-os-kernel?fileGuid=gXqmevn42YSgQpqo) 中15个以上的syscall，通过相关测试用例(难度：6)
